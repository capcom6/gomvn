...
const docTemplate = `{
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/server.apiPutUsersPathsRequestItem"
                            }
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/server.apiPutUsersPathsResponseItem"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "server.apiPutUsersPathsRequestItem": {
            "type": "object",
            "properties": {
                "deploy": {
                    "description": "Allowed to deploy",
        ...
        "server.apiPutUsersPathsResponseItem": {
            "type": "object",
            "properties": {
                "deploy": {
                    "description": "Allowed to deploy",
